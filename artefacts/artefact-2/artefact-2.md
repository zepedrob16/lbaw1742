...
`BR03` | `Downvote Threshold` | `When a submission/comment reaches a certain number of downvotes, the content is automatically flagged as controversial and is filtered out.`
